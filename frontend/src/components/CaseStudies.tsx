...
const caseStudies = [
  {
    ...
    performanceImages: [
      {
        src: '/assets/generated/meta-ads-performance-1.dim_1200x800.png',
        alt: 'VR Health Science Meta Ads Campaign Performance - December 2025 showing ₹1.45L total spend, 2.6M impressions, 571K reach with detailed campaign metrics'
      },
      {
        src: '/assets/generated/meta-ads-performance-2.dim_1200x800.png',
        alt: 'VR Health Science Meta Ads Campaign Performance - October to December 2025 showing ₹3.48L total spend, 6.3M impressions, 2.1M reach with comprehensive campaign data'
      }
    ]
  },
  {
            ...
            <div key={study.id}>
              ...
              <Card className="bg-white border border-border shadow-soft hover:shadow-elevated transition-all duration-300">
                ...
                <CardContent className="space-y-8">
                  ...
                  {/* Performance Gallery (only for VRH Derma - Case Study 1) */}
                  {study.performanceImages && (
                    <PerformanceGallery images={study.performanceImages} />
                  )}
                </CardContent>
              </Card>
            </div>
