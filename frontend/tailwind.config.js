    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                'professional-green': 'oklch(var(--professional-green))',
                'strong-black': 'oklch(var(--strong-black))',
                'dark-grey': 'oklch(var(--dark-grey))',
                primary: {
            ...
            boxShadow: {
                ...
                elevated: '0 8px 24px rgba(0, 0, 0, 0.08), 0 2px 6px rgba(0, 0, 0, 0.08)',
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
